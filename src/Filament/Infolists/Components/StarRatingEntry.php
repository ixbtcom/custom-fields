...
namespace Webkul\CustomFields\Filament\Infolists\Components;

use Closure;
use Filament\Infolists\Components\Entry;

class StarRatingEntry extends Entry
{
    protected string $view = 'custom-fields::filament.infolists.components.star-rating-entry';
